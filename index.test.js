const previousValue = require('./lib/previousValue.js'); 
...
beforeAll(() => {
  ...
  const diffs1 = [
    ...
    {path: '/contacts/0', old_value: {name: 'old name', phones: ['old phone 1', 'old phone 2'], emails: ['old email 1', 'old email 2']}},
  ]
...
describe('previousValue', () => {
  ...
  test('Restored without changes. Should return undefined', () => {
    expect(previousValue(changed_customer, [], '')).toBe(undefined);
  });
